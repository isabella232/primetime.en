...
uuid: 5c45eb8c-6b36-40ad-8933-b12deb0911d6
index: y
internal: n
snippet: y
translate: y
...
* Adobe recommends using at least Version 2 of HLS for playback in TVSDK-based clients. Clients and servers must implement the versions in the following way: 
