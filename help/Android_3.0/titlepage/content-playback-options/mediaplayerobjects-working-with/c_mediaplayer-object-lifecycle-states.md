...
uuid: 64dbc3fc-4836-4ada-b8c2-a3158d9aef2f
index: y
internal: n
snippet: y
translate: y
...
* The list of statuses is defined in the [MediaPlayerStatus](https://help.adobe.com/en_US/primetime/api/psdk/javadoc2.5/index.html) enum.




Status-transition diagram for the lifecycle of a `MediaPlayer` instance: <a id="fig_A6425F24C7734DC681D992859D2A6743"></a> ![](assets/media_player_statuses.png) 
