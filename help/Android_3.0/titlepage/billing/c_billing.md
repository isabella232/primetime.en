...
uuid: eda1ce49-789f-4f92-8e33-9c71efc4760d
index: y
internal: n
snippet: y
translate: y
...
* Content type (live, linear, or VOD)* Content URL* Whether ads are enabled* Whether mid-roll ads are enabled (VOD only)* Whether the stream is protected by DRM* The TVSDK version and platform
