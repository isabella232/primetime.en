...
uuid: e2f891eb-6cce-49a2-a4a7-00a925da0497
index: y
internal: n
snippet: y
translate: y
...
1. Use the `DRMMetadata` to check whether authentication is needed.
    ...
    * If authentication is not required, you do not need to do anything, and playback continues uninterrupted.* If authentication is required, complete DRM authentication. Since this operation is asynchronous and is handled in a different thread, it has no impact on the user interface nor on video playback. 
