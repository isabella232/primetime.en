...
To use these saved `PTTimedMetadata` objects during playback, use the saved  dictionary  from [Store timed-metadata objects as they are dispatched](../../../tvsdk-3.4-for-ios/ios-3.4-advertising/ios-3.4-custom-tags-configure/ios-3.4-timed-metadata-store.md). 
