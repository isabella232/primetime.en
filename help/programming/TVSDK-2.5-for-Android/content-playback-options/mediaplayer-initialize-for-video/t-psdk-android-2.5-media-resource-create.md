...
uuid: 4cdbcdec-215b-4cc1-af02-2a8a0b43a8ba
index: y
internal: n
snippet: y
---
...
1. Load the media resource using one of the following options:
    ...
    * `MediaPlayerItemLoader` For more information, see [Load a media resource using MediaPlayerItemLoader](../../content-playback-options/mediaplayer-initialize-for-video/t-psdk-android-2.5-media-resource-load-using-mediaplayeritemloader.md#use-mediaplayeritemloader).
