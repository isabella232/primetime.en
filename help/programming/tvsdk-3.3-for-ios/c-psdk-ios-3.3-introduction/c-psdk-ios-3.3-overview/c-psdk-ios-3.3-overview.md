...
* For a list of the features that are supported by TVSDK, see [Primetime Player TVSDK features](../../c-psdk-ios-3.3-introduction/c-psdk-ios-3.3-overview/c-psdk-ios-3.3-overview-of-the-player.md).
* For specific hardware and software requirements for using TVSDK, see [Requirements](../../c-psdk-ios-3.3-introduction/c-psdk-ios-3.3-requirements.md) .
