...
uuid: f66d1060-8d0f-4ed2-93ff-80834a32e913
index: y
internal: n
snippet: y
---
...
* For a list of the features that are supported by TVSDK, see [Primetime TVSDK features](../introduction/overview-of-the-player.md). 
* For specific hardware and software requirements for using TVSDK, see [Requirements](../introduction/requirements.md). 
