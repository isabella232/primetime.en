...
uuid: 32b85280-383b-49d2-8ffc-45136d87c244
index: y
internal: n
snippet: y
---
...
* For REPLACE ranges, if the signaling mode is set as the server map or manifest cues, the ranges are replaced as specified in the REPLACE ranges, and there is no ad insertion through server map or manifest cues.
  ...
  For more information, see the *Signaling Mode / Metadata Combination Behaviors* table in [Effect on ad insertion and deletion from ad signaling mode and ad metadata combinations](../../advertising/delete-replace-contenvod/signaling-mode-android.md). .
