...
uuid: d89576aa-85ff-4a31-b6cc-bebe49932044
index: y
internal: n
snippet: y
---
...
<table id="table_7F713B7A56024D8DA3C84E449D09CC91"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><span class="codeph"> ERROR_CODE</span> </td> 
  ...
  <tr> 
   <td colname="col1"><span class="codeph"> MANIFESERROR</span> </td> 
   <td colname="col2"> Description of error during manifest file download. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"> CONTENERROR</span> </td> 
...
<table id="table_5EEB1F60E5854452A8B0BABBE9B32651"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> FILE_NOFOUND </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> LOSCONNECTION_RECOVERABLE </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> NOIMPLEMENTED </span> </td> 
   <td colname="col3"> Feature not implemented. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 11 </td> 
   <td colname="col2"><span class="codeph"> OUOF_MEMORY </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> SOURCE_NOSPECIFIED </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> COMPONENCREATION_FAILURE</span> </td> 
   <td colname="col3"> An essential component could not be created. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 28 </td> 
   <td colname="col2"><span class="codeph"> DRM_INIERROR</span> </td> 
   <td colname="col3"> Failed to create DRM context. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 29 </td> 
   <td colname="col2"><span class="codeph"> CONTAINER_NOSUPPORTED </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> CODEC_NOSUPPORTED</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> VIDEO_PROFILE_NOSUPPORTED</span> </td> 
   <td colname="col3"> Unsupported video profile. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 36 </td> 
   <td colname="col2"><span class="codeph"> PERIOD_NOLOADED</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> FRAGMENREAD_ERROR</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> CANNOFAIL_OVER</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> BAD_MANIFESSIGNATURE</span> </td> 
   <td colname="col3"> The manifest has a bad signature. It failed the manifest signing test. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 47 </td> 
   <td colname="col2"><span class="codeph"> CANNOLOAD_PLAYLIST</span> </td> 
   <td colname="col3"> Cannot load a playlist. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 48 </td> 
   <td colname="col2"><span class="codeph"> REPLACEMENFAILED</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> CURRENPERIOD_EXPIRED</span> </td> 
   <td colname="col3"> Live window moved beyond the current period. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 52 </td> 
   <td colname="col2"><span class="codeph"> CONTENLENGTH_MISMATCH</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> DRM_NOAVAILABLE</span> </td> 
   <td colname="col3"> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 57 </td> 
   <td colname="col2"><span class="codeph"> PLAYBACK_NOAUTHORIZED</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> POSTROLL_WITH_LIVE_NOALLOWED</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> SEGMENSKIPPED_ON_FAILURE</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> PROTOCOL_NOSUPPORTED </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> MANIFESFILE_UNEXPECTEDLY_CHANGED</span> </td> 
   <td colname="col3"> Manifest file was changed in an unexpected manner. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 71 </td> 
   <td colname="col2"><span class="codeph"> CANNOSPLITIMELINE</span> </td> 
   <td colname="col3"> Cannot perform a split operation on a timeline. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 72 </td> 
   <td colname="col2"><span class="codeph"> CANNOERASE_TIMELINE</span> </td> 
   <td colname="col3"> Cannot perform an erase operation on a timeline. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 73 </td> 
   <td colname="col2"><span class="codeph"> DID_NOGENEXFRAGMENT</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> LISTENER_NOFOUND</span> </td> 
   <td colname="col3"> No listener found in an internal data structure. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 76 </td> 
   <td colname="col2"><span class="codeph"> AUDIO_STARERROR</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> KEY_NOFOUND </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> KEY_SERVER_NOFOUND</span> </td> 
   <td colname="col3"> Key server does not return a key. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 90 </td> 
   <td colname="col2"> <span class="codeph"> MAIN_MANIFESUPDATE_TO_BE_HANDLED</span> </td> 
...
|---|---|---|
|  300  | `CRYPTO_ALGORITHM_NOSUPPORTED`  | Algorithm being used is not supported.  |
...
|  304  | `CRYPTO_ERROR_DIGESUPDATE`  | Digest update.  |
|  305  | `CRYPTO_ERROR_DIGESFINISH`  | Digest finish.  |
