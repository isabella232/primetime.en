...
uuid: 8977e0bc-fe20-4624-a334-60305ec9b1dc
index: y
internal: n
snippet: y
---
...
1. To implement a control bar with DVR support, follow the steps in [Display a seek scrub bar with the current playback position](../../content-playback-options-android2/ui-configure/ui-seek-scrub-bar-display.md) with the following differences:
