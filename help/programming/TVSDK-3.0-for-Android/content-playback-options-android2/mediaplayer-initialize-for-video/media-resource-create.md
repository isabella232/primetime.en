...
uuid: 799368cf-3c3f-47a2-94a7-d3201c63b5c8
index: y
internal: n
snippet: y
---
...
1. Load the media resource using one of the following options:
    ...
    * `MediaPlayerItemLoader` For more information, see [Load a media resource using MediaPlayerItemLoader](../../content-playback-options-android2/mediaplayer-initialize-for-video/media-resource-mediaplayeritemloader.md)
