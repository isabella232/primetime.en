...
The main audio track is included in the audio tracks collection with the `codeph default` label. Metadata for the alternate audio streams is included in the playlist in the `codeph #EXT-X-MEDIA` tags with `codeph TYPE=AUDIO`.
