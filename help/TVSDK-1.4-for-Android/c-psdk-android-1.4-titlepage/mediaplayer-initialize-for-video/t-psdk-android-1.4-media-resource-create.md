...
uuid: 9a85b98d-6ab0-4c28-adb0-04d587ca1f2d
index: y
internal: n
snippet: y
---
...
1. Load the media resource by using the following:
    ...
    * Your MediaPlayer instance.
      ...
      For more information, see [Load a media resource in the MediaPlayer](../../c-psdk-android-1.4-titlepage/mediaplayer-initialize-for-video/t-psdk-android-1.4-media-resource-load.md). 
    * A `MediaPlayerItemLoader` For more information, see [Load a media resource using MediaPlayerItemLoader](../../c-psdk-android-1.4-titlepage/mediaplayer-initialize-for-video/t-psdk-android-1.4-media-resource-load-using-mediaplayeritemloader.md).
