...
uuid: 32538976-c45f-4b77-bef3-e3f674d2bccf
index: y
internal: n
snippet: y
translate: y
...
1. Create  instance for each companion ad slot on your page.
    ...
    * To prevent the retrieval of companion ads of different sizes, a banner instance that specifies the width and height.* Standard banner sizes.    
