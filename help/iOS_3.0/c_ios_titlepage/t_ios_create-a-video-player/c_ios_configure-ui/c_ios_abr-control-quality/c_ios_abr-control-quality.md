...
uuid: b8267898-f441-4779-af87-3ba6c24bef95
index: y
internal: n
snippet: y
translate: y
...
* TVSDK does not dispatch events from bit-rate switching.* You can change your ABR settings at any time, and the player switches to use the profile that most closely matches the most recent settings.
