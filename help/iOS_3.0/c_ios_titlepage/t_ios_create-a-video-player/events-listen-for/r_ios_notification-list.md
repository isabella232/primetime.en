---
description: ThePTMediaPlayerNotifications class lists the notifications that the TVSDK dispatches to your player. WRITER  Updated as of PSDK_iOS_1.4.6.325 build.
seo-description: ThePTMediaPlayerNotifications class lists the notifications that the TVSDK dispatches to your player. WRITER  Updated as of PSDK_iOS_1.4.6.325 build.
seo-title: iOS notifications
title: iOS notifications
uuid: 290cdf07-fda4-49ed-a945-a944e95506bf
index: y
internal: n
snippet: y
translate: y
...
ThePTMediaPlayerNotifications class lists the notifications that the TVSDK dispatches to your player. WRITER: Updated as of PSDK_iOS_1.4.6.325 build.
