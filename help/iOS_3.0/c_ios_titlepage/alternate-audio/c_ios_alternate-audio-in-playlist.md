...
uuid: 954924eb-cb81-4270-a0b2-3e6da877b65b
index: y
internal: n
snippet: y
translate: y
...
* If the main content has alternate audio tracks, ads must have at least one audio-only stream.* Each segment duration of an ad's audio-only stream must be equal to the segment duration of an ad's video stream.
