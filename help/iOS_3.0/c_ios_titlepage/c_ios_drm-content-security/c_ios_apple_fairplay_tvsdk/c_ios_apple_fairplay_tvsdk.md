...
uuid: 04483fda-fe08-4aa0-82cc-9f2ca585b1ec
index: y
internal: n
snippet: y
translate: y
...
1. Determine where to send the license acquisition request.1. Format the request.1. Provide the necessary information to the server, so that the server can decide whether the request should be permitted.
